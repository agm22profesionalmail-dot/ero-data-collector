...
const CREDIT = "Character sheet &amp; 3D render: ERO Data Collector by @_ZeroSplat";
...
<ol class="edc-terms-list">
  ...
  <li><b>Beta announcement.</b> Once you are approved, publish one post on any of your social networks saying that you take part in the ERO Data Collector Artist Beta, with a link to the website. One post is enough.</li>
  <li><b>Permission to feature your OCs.</b> You allow ERO's Team to use the original characters (OCs) you register in ERO Data Collector in its content and activities: in-game photos, events, promotional posts and showcases. <b>You will always be credited and tagged.</b> You can ask for an OC to be excluded from future content at any time.</li>
